...
function getPrivacyHeaders() {
    return {
        ...
        // 0, а не «1; mode=block»: встроенный XSS-фильтр старых браузеров сам
        // был источником утечек, а в новых его нет. Защищает CSP.
        'X-XSS-Protection': '0',
        'Referrer-Policy': 'no-referrer',
        // Камера — только своей странице: ею сканируют QR-код при сверке
        // ключей. Встроенному чужому содержимому она недоступна.
